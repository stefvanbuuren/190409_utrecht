...
*Can we use MICE-algorithm for multilevel data, and if so, how?*
...
## Missing data patterns, multivariate
...
## Univariate continuous multilevel imputation in `mice`
![](figures/fig1.png)

## Univariate binary and count multilevel imputation in `mice`
![](figures/fig3.png)

## Univariate level-2 imputation in `mice`
![](figures/fig2.png)
